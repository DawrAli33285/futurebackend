...
function getNatalPlanetChakra(planetName) {
  const chakraMap = {
    'Moon':    'Moon (Crown Chakra)',
    'Mercury': 'Mercury (Third Eye Chakra)',
    'Venus':   'Venus (Throat Chakra)',
    'Sun':     'Sun (Heart Chakra)',
    'Mars':    'Mars (Solar Plexus Chakra)',
    'Jupiter': 'Jupiter (Sacral Chakra)',
    'Saturn':  'Saturn (Root Chakra)'
  };
  return chakraMap[planetName] || planetName;
}
...
<td style="padding: 10px; border-bottom: 1px solid #ecf0f1;"><strong>${getNatalPlanetChakra(t.natalPlanet)}</strong></td>
 ...
 <thead>
  <tr style="background: #f8f9fa;">
    ...
    <th style="padding: 12px; text-align: left; border-bottom: 2px solid #667eea;">Natal Planet Chakra</th>
